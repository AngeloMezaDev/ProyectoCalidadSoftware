...
public class frmInventario extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        // Caso 2: Filtrar por la selección de cmbCategoria en la columna de categoría (columna 4)
        String categoriaSeleccionada = cmbCategoria.getSelectedItem().toString();
        if (!categoriaSeleccionada.equals("Seleccione una categoria...")) {
            try {
                ...
                System.err.println("Error en el patrón de búsqueda de categoría: " + e.getMessage());
            }
        }
        ...
        if (!textoBusqueda.isEmpty() && !categoriaSeleccionada.equals("Seleccione una categoria...")) {
            try {
                ...
                filters.clear(); // Limpiar los filtros anteriores
        ...
        if (sorter.getViewRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "No se encontraron resultados.", "Búsqueda sin resultados", JOptionPane.ERROR_MESSAGE);
             txtBusqueda.setText("");
            cmbCategoria.setSelectedItem("Seleccione una categoria...");
    ...
    public void configurarRenderizadorEstado() {
        TableColumn estadoColumn = jTableInventario.getColumnModel().getColumn(6);
        estadoColumn.setCellRenderer(new frmInventario.CustomComboBoxRenderer());
    }
