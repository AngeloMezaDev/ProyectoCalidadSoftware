...
public class frmNuevoProducto extends javax.swing.JFrame {
    ...
    public frmNuevoProducto(frmAdmin Producto) {
        try {
            initComponents();
            this.Producto = Producto;
            ((JSpinner.DefaultEditor) jsCantidad.getEditor()).getTextField().setEditable(false); // No permite editar el JSpinner
            ...
            comboBoxModel.addElement("Seleccione un proveedor..."); // Mensaje por defecto

            // Agregar los nombres de los proveedores al modelo
            for (Proveedor proveedor : proveedores) {
                comboBoxModel.addElement(proveedor.getIdProveedor() + " - " + proveedor.getNombre());
            }

            // Configurar el JComboBox para usar el modelo
            cmbProveedor.setModel(comboBoxModel);

            // Seleccionar el mensaje por defecto
            cmbProveedor.setSelectedItem("Seleccione un proveedor...");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            try {
                controladorProductos.insertarNuevoProducto(idProducto, nombre, cantidad, precio, categoria, proveedorId);
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        int opcion = JOptionPane.showConfirmDialog(this, "¿Desea cancelar el añadir un nuevo producto?", "Confirmar cancelación", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frmNuevoProducto nuevoProducto = new frmNuevoProducto(Producto);
