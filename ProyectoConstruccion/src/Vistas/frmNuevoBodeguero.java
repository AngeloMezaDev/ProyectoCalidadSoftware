...
public class frmNuevoBodeguero extends javax.swing.JFrame {
    ...
    public frmNuevoBodeguero() {
        try {
            initComponents();
            ctrlBodegueroAdmin bodegueroAdmin = new ctrlBodegueroAdmin();
            int idActual = bodegueroAdmin.obtenerValorActualSecuencia();
            lblID.setText(String.valueOf(idActual));  // Convierte el ID a String y establece el texto en el JLabel
        } catch (SQLException ex) {
            Logger.getLogger(frmNuevoBodeguero.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // jPasswordConfirmarContrasena.setText("");

        // También puedes cerrar el formulario si es necesario
        // this.dispose();
    } catch (Exception e) {
